    ...
    describe('Utils', function () {
        ...
        describe('logger', function () {
            ...
            it('should log', function () {
                ...
                console.log = log => {
                    assert(
                        JSON.stringify(log) === JSON.stringify(res),
                        `Logged ${JSON.stringify(log)} instead of ${JSON.stringify(res)}`
                    );
                };
                ...
                res = `${chalk.bold.red('[ERROR]')} ${chalk.italic.hex('#C5C8C6')('path/')}${chalk.bold.italic.blue(
                    'test.txt'
                )}`;
                logger.error('path/test.txt', undefined, true);
                res = `${chalk.bold.green('[SUCCESS]')} ${chalk.italic.hex('#C5C8C6')('path/')}${chalk.bold.italic.blue(
                    'test.txt'
                )}`;
                logger.succ('path/test.txt', undefined, true);
                res = `${chalk.bold.yellow('[WARNING]')} ${chalk.italic.hex('#C5C8C6')(
                    'path/'
                )}${chalk.bold.italic.blue('test.txt')}`;
                logger.warn('path/test.txt', undefined, true);
                res = `${chalk.bold.blue('[INFO]')} ${chalk.italic.hex('#C5C8C6')('path/')}${chalk.bold.italic.blue(
                    'test.txt'
                )}`;
